...
bool ValidateExponent(int exponent)
{
    if (exponent < 0)
    {
        Console.WriteLine("Пожалуйста, введите число (степень) больше нуля");
        return false;
    }
    return true;
}
 
int powerBase = Prompt("Введите основание (число А): ");
int exponent = Prompt("Введите степень (число В): ");
